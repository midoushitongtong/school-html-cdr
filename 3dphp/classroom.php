<?php 
  define('IN_TG',true);
  define('SCRIPT','classroom');
  require dirname(__FILE__).'/includes/common.inc.php';
  _page("SELECT id FROM 3d_posts WHERE post_status = 'publish' AND
                            id in(SELECT object_id FROM 3d_term_relationships WHERE term_taxonomy_id = 13)",12);
  $_result = _query("SELECT
                      ...
                      WHERE
                            post_status = 'publish'
                        AND
                            id in (SELECT object_id FROM 3d_term_relationships WHERE term_taxonomy_id = 13)
                   ORDER BY
                            post_modified
                       DESC
                            LIMIT
	...
	<div id="content">
		<div id="content_main">
			<div id="left">
				...
				<div>
					<ul>
						<li><a href="teach.php">学生作品</a></li>
						<li class="bg"><a href="classroom.php">精彩课堂</a></li>
