<?php 
  ...
  _page("SELECT id FROM 3d_posts WHERE post_status = 'publish'AND
                            id in(SELECT object_id FROM 3d_term_relationships WHERE term_taxonomy_id = 12)",15);
  $_result = _query("SELECT
                      ...
                      WHERE
                            post_status = 'publish'
                        AND
                            id in (SELECT object_id FROM 3d_term_relationships WHERE term_taxonomy_id= 12)
                   ORDER BY
                            post_modified
                       DESC
                            LIMIT
...
<head>	
	...
	<link type="text/css" rel="stylesheet" href="style/trade.css">
	...
	<div id="content">
		<div id="content_main">
			<div id="left">
				...
				<div>
					<ul>
						<li><a href="news.php">唯识创梦新闻</a></li>
						<li class="bg"><a href="trade.php">3D行业新闻</a></li>
					</ul>
				</div>
			</div>
			<div id="center">
				  ...
				  <ul id="wrap">
					<?php 
                      ...
                      while(!!$_rows = _fetch_array_list($_result)){
                        ...
                        echo '<li><a href="trade-content.php?id='.$_htmllist['id'].'">'._title($_htmllist['title'],23.3).'</a><strong>('._title($_htmllist['read'],2).') 阅读</strong><em>'.$_htmllist['date'].'</em></li>';                      
                      }
